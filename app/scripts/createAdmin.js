...
var admin_model_1 = require("../models/admin.model"); // Adjust path to your model
dotenv.config(); // Load environment variables
function createAdmin() {
    return __awaiter(this, void 0, void 0, function () {
        var adminExists, admin, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, admin_model_1.default.findOne({ username: "admin" })];
                case 2:
                    adminExists = _a.sent();
                    if (adminExists) {
